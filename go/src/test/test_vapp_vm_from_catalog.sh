...
export TF_VAR_TARGET_VM_NAME="pcp_hi_210"
...
go test github.com/vmware/terraform-provider-vcloud-director/go/src/vcd/provider/ -v -run TestAccResourceVappVmFromCatalog | grep --line-buffered -vE 'DEBUG|TRACE|terraform|^$'
